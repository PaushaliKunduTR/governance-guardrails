...
1. Write the JSON schema describing your resource, `paushalisb-guardraildemo-hook.json`
2. Implement your resource handlers in `paushalisb_guardraildemo_hook/handlers.py`
